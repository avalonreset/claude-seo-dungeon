...
Legends SEO Dungeon does not require Model Context Protocol (MCP) servers for
normal audits. DataForSEO, Firecrawl, and Google workflows should use project
`.env` credentials and direct API/scripts first. MCP servers remain optional
adapters for users who already run them and want reusable tool-style access.
...
For organic search data, Legends SEO Dungeon can use Google credentials directly through
...
If you don't have API keys, Legends SEO Dungeon can still:
