...
On Windows, Legends SEO Dungeon resolves local `.ps1`, `.cmd`, `.bat`, and `.exe` shims
...
Legends SEO Dungeon uses SSRF-safe fetchers. Private IPs, loopback hosts, and metadata
