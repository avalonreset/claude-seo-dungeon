...
function parseArgs(argv) {
  const options = {
    ...
    domain: process.env.SEO_DUNGEON_DESKTOP_PROOF_DOMAIN || 'example.com',
...
function usage() {
  return [
    'Usage:',
    '  node scripts/record-desktop-proof.mjs [--output-dir path] [--domain example.com] [--project /path/to/your/project]',
