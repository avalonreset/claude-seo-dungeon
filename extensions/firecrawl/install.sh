...
main() {
    ...
    if [ ! -d "${SEO_SKILL_DIR}" ]; then
        ...
        echo "  Normal Legends SEO Dungeon audits do not require this installer."
    ...
    echo "Sign up at: https://www.firecrawl.dev/signup"
    ...
    if [ -f "${SCRIPT_DIR}/skills/seo-firecrawl/SKILL.md" ]; then
        ...
        echo "  Run this script from the legends-seo-dungeon repo: ./extensions/firecrawl/install.sh"
        exit 1
    fi
