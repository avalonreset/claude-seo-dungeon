# Legends SEO Dungeon uninstaller for Windows
...
function Remove-Suite {
    ...
    Write-Host "[INFO] Removing Legends SEO Dungeon $Label install from $Root" -ForegroundColor Yellow
...
Write-Host "[OK] Legends SEO Dungeon skills removed for Codex." -ForegroundColor Green
