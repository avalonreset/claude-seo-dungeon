# Contributing to Legends SEO Dungeon

Thanks for your interest in contributing! Here's how to get involved.

## Reporting Bugs

Open a [GitHub Issue](https://github.com/avalonreset/legends-seo-dungeon/issues) with:
...
Use [GitHub Discussions](https://github.com/avalonreset/legends-seo-dungeon/discussions) for feature ideas and questions.
...
```bash
git clone https://github.com/YOUR_USERNAME/legends-seo-dungeon.git
cd legends-seo-dungeon
bash install.sh
```
...
- Python scripts should output JSON or structured text that local CLI runtimes can parse
...
Legends SEO Dungeon accepts community-built extensions through challenges and PRs.
...
5. Submit a PR or discussion in the Legends SEO Dungeon repository.
